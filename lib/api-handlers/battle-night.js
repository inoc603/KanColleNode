...
function getNightBattle (req, data, admiral) {
  ...
  friendly.casualty = battleUtil.calculateNightCasualty(friendly.ships
                        , admiral.lastBattle.friendly.ships)
  enemy.casualty = battleUtil.calculateNightCasualty(enemy.ships
                     , admiral.lastBattle.enemy.ships)

  var send = {}
  send.friendly = friendly
  send.enemy = enemy

  send.rank = battleUtil.calculateRank(send)
