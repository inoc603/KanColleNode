...
function getCombinedBattle (req, data, admiral) {
  ...
  // fire round 1 by the front fleet
  ...
  // closing tropedo by the front fleet
  ...
  // fire round 2 by the back fleet
  ...
  // fire round 3 by the back fleet
...
module.exports.api = ['/api_req_combined_battle/battle']
