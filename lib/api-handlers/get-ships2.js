...
function updateFleet (fleetId, admiral) {
  var fleet = admiral.fleets[fleetId]
    , tempShips = []
  ...
  admiral.fleets[fleetId] = tempFleet
}
...
module.exports.api = ['/api_get_member/ship2']
